...
Now I am just writing my text as though I am in a MSWord document. I don't need to worry about keeping the sentences short like in the R scripts or starting each sentence with a #.
...
To learn more visit [the R Markdown webpage](http://rmarkdown.rstudio.com/)
